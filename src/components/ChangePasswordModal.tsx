...
const ChangePasswordModal: React.FC<Props> = ({ onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
            <div className="bg-white dark:bg-zinc-900 transition-colors rounded-[2rem] shadow-2xl w-full max-w-md overflow-hidden relative animate-in fade-in zoom-in duration-200">
                <div className="absolute top-0 left-0 w-full h-2 bg-[#E31E24]"></div>

                <button
                    onClick={onClose}
                    className="absolute top-4 right-4 text-zinc-400 hover:text-[#231F20] dark:text-zinc-100 transition-colors p-2"
                >
                ...
                <div className="p-8">
                    <div className="flex items-center gap-3 mb-6 block w-fit">
                        ...
                        <h2 className="text-xl font-black text-[#231F20] dark:text-zinc-100 uppercase tracking-tighter italic">Trocar <span className="text-[#E31E24]">Senha</span></h2>
                    </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 bg-zinc-50 dark:bg-zinc-950/50 transition-colors border border-zinc-200 dark:border-zinc-700 transition-colors rounded-xl text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-[#E31E24]/30 focus:border-[#E31E24] transition-all"
                                />
                            </div>
